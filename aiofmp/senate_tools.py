...
async def get_latest_senate_disclosures(
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved latest senate disclosures"
        )
...
async def get_house_trading_activity(symbol: str) -> Dict[str, Any]:
    ...
    try:
        ...
        client = get_fmp_client()
        async with client:
            results = await client.senate.house_trading_activity(symbol=validated_symbol)
...
async def get_latest_house_disclosures(
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved latest house disclosures"
        )
...
async def get_senate_trading_activity(symbol: str) -> Dict[str, Any]:
    ...
    try:
        ...
        client = get_fmp_client()
        async with client:
            results = await client.senate.senate_trading_activity(symbol=validated_symbol)
...
async def get_senate_trades_by_name(name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved senate trades for {name}"
        )
...
async def get_house_trades_by_name(name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved house trades for {name}"
        )
