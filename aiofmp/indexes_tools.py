...
async def get_index_quote(symbol: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving index quote: {str(e)}"
        )
...
async def get_index_list() -> Dict[str, Any]:
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving index list: {str(e)}"
        )
...
@mcp.tool
async def get_all_index_quotes(short: Optional[bool] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved all index quotes"
        )
