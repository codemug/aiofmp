...
async def get_treasury_rates(
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved treasury rates"
        )
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving treasury rates: {str(e)}"
        )
...
async def get_economic_calendar(
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved economic calendar events"
        )
...
async def get_market_risk_premium() -> Dict[str, Any]:
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message="Retrieved market risk premium data"
        )
