...
async def get_fmp_articles(
    ...
    try:
        ...
        return create_tool_response(
            data=results,
            success=True,
            message=f"Retrieved {len(results)} FMP articles"
        )
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving FMP articles: {str(e)}"
        )
...
async def get_stock_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving stock news: {str(e)}"
        )
...
async def get_general_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving general news: {str(e)}"
        )
...
async def get_press_releases(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving press releases: {str(e)}"
        )
...
async def get_crypto_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving crypto news: {str(e)}"
        )
...
async def get_forex_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error retrieving forex news: {str(e)}"
        )
...
async def search_press_releases(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error searching press releases: {str(e)}"
        )
...
async def search_stock_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error searching stock news: {str(e)}"
        )
...
async def search_crypto_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error searching crypto news: {str(e)}"
        )
...
async def search_forex_news(
    ...
    try:
        ...
        return create_tool_response(
            data=[],
            success=False,
            message=f"Error searching forex news: {str(e)}"
        )
