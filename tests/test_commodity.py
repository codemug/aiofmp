...
class TestCommodityCategory:
    ...
    @pytest.mark.asyncio
    async def test_commodities_list_response_structure(self, commodity_category, mock_client):
    ...
    async def test_quote_short_basic(self, commodity_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("quote-short", {"symbol": "GCUSD"})
    
    @pytest.mark.asyncio
    async def test_quote_short_response_structure(self, commodity_category, mock_client):
        ...
        mock_client._make_request.assert_called_once_with("quote-short", {"symbol": "CLUSD"})
    ...
    async def test_historical_price_light_basic(self, commodity_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("historical-price-eod/light", {"symbol": "GCUSD"})
    
    @pytest.mark.asyncio
    async def test_historical_price_light_with_dates(self, commodity_category, mock_client):
        """Test historical price light with date parameters"""
        mock_response = [{"symbol": "GCUSD", "date": "2025-07-24", "price": 3373.8, "volume": 174758}]
        mock_client._make_request.return_value = mock_response
        
        result = await commodity_category.historical_price_light("GCUSD", "2025-04-25", "2025-07-25")
    ...
    @pytest.mark.asyncio
    async def test_historical_price_light_with_from_date_only(self, commodity_category, mock_client):
        """Test historical price light with only from_date parameter"""
        mock_response = [{"symbol": "GCUSD", "date": "2025-07-24", "price": 3373.8}]
        mock_client._make_request.return_value = mock_response
        
        result = await commodity_category.historical_price_light("GCUSD", from_date="2025-04-25")
        
        assert result == mock_response
        mock_client._make_request.assert_called_once_with(
            "historical-price-eod/light",
            {"symbol": "GCUSD", "from": "2025-04-25"}
        )
    
    @pytest.mark.asyncio
    async def test_historical_price_light_with_to_date_only(self, commodity_category, mock_client):
        """Test historical price light with only to_date parameter"""
        mock_response = [{"symbol": "GCUSD", "date": "2025-07-24", "price": 3373.8}]
        mock_client._make_request.return_value = mock_response
        
        result = await commodity_category.historical_price_light("GCUSD", to_date="2025-07-25")
        
        assert result == mock_response
        mock_client._make_request.assert_called_once_with(
            "historical-price-eod/light",
            {"symbol": "GCUSD", "to": "2025-07-25"}
        )
    ...
    async def test_historical_price_full_basic(self, commodity_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("historical-price-eod/full", {"symbol": "GCUSD"})
    
    @pytest.mark.asyncio
    async def test_historical_price_full_with_dates(self, commodity_category, mock_client):
        """Test historical price full with date parameters"""
        mock_response = [{"symbol": "GCUSD", "date": "2025-07-24", "open": 3398.6, "close": 3373.8}]
        mock_client._make_request.return_value = mock_response
        
        result = await commodity_category.historical_price_full("GCUSD", "2025-04-25", "2025-07-25")
    ...
    async def test_intraday_1min_basic(self, commodity_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("historical-chart/1min", {"symbol": "GCUSD"})
    ...
    async def test_intraday_1min_with_dates(self, commodity_category, mock_client):
        ...
        result = await commodity_category.intraday_1min("GCUSD", "2025-04-25", "2025-07-25")
    ...
    async def test_intraday_5min_basic(self, commodity_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("historical-chart/5min", {"symbol": "GCUSD"})
    ...
    async def test_intraday_5min_with_dates(self, commodity_category, mock_client):
        ...
        result = await commodity_category.intraday_5min("GCUSD", "2025-04-25", "2025-07-25")
    ...
    async def test_intraday_1hour_basic(self, commodity_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("historical-chart/1hour", {"symbol": "GCUSD"})
    
    @pytest.mark.asyncio
    async def test_intraday_1hour_with_dates(self, commodity_category, mock_client):
        """Test intraday 1hour with date parameters"""
        mock_response = [{"date": "2025-07-24 11:30:00", "open": 3378.4, "close": 3374.4}]
        mock_client._make_request.return_value = mock_response
        
        result = await commodity_category.intraday_1hour("GCUSD", "2025-04-25", "2025-07-25")
    ...
    @pytest.mark.asyncio
    async def test_commodities_list_response_validation(self, commodity_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_historical_price_full_response_validation(self, commodity_category, mock_client):
