...
class TestEtfAndMutualFundsCategory:
    ...
    async def test_holdings_basic(self, etf_category, mock_client):
        ...
        mock_client._make_request.assert_called_once_with("etf/holdings", {"symbol": "SPY"})
    ...
    async def test_country_weightings_basic(self, etf_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("etf/country-weightings", {"symbol": "SPY"})
    
    @pytest.mark.asyncio
    async def test_country_weightings_response_structure(self, etf_category, mock_client):
        """Test country weightings response structure"""
        mock_response = [
            {
                "country": "United States",
                "weightPercentage": "95.50%"
            },
            {
                "country": "Japan",
                "weightPercentage": "2.30%"
            },
            {
                "country": "Germany",
                "weightPercentage": "1.20%"
            }
        ]
        mock_client._make_request.return_value = mock_response
        ...
        mock_client._make_request.assert_called_once_with("etf/country-weightings", {"symbol": "VTI"})
    ...
    async def test_asset_exposure_basic(self, etf_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("etf/asset-exposure", {"symbol": "AAPL"})
    ...
    async def test_asset_exposure_response_structure(self, etf_category, mock_client):
        ...
        mock_client._make_request.assert_called_once_with("etf/asset-exposure", {"symbol": "MSFT"})
    ...
    async def test_sector_weightings_basic(self, etf_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("etf/sector-weightings", {"symbol": "SPY"})
    
    @pytest.mark.asyncio
    async def test_sector_weightings_response_structure(self, etf_category, mock_client):
        ...
        mock_client._make_request.assert_called_once_with("etf/sector-weightings", {"symbol": "VTI"})
    ...
    async def test_disclosure_holders_latest_basic(self, etf_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("funds/disclosure-holders-latest", {"symbol": "AAPL"})
    
    @pytest.mark.asyncio
    async def test_disclosure_holders_latest_response_structure(self, etf_category, mock_client):
        ...
        mock_client._make_request.assert_called_once_with("funds/disclosure-holders-latest", {"symbol": "MSFT"})
    ...
    @pytest.mark.asyncio
    async def test_sector_weightings_response_validation(self, etf_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_disclosure_holders_latest_response_validation(self, etf_category, mock_client):
