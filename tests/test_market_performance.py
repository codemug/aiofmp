...
class TestMarketPerformanceCategory:
    ...
    @pytest.mark.asyncio
    async def test_sector_performance_snapshot_basic(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.sector_performance_snapshot(snapshot_date)
    ...
    @pytest.mark.asyncio
    async def test_sector_performance_snapshot_with_optional_params(self, market_performance_category, mock_client):
        """Test sector performance snapshot with all parameters"""
        mock_response = [{"date": "2024-02-01", "sector": "Energy", "exchange": "NASDAQ", "averageChange": 0.5}]
        mock_client._make_request.return_value = mock_response
    ...
    @pytest.mark.asyncio
    async def test_industry_performance_snapshot_basic(self, market_performance_category, mock_client):
        ...
        snapshot_date = date(2024, 2, 1)
        result = await market_performance_category.industry_performance_snapshot(snapshot_date)
    ...
    @pytest.mark.asyncio
    async def test_industry_performance_snapshot_with_optional_params(self, market_performance_category, mock_client):
        """Test industry performance snapshot with all parameters"""
        mock_response = [{"date": "2024-02-01", "industry": "Biotechnology", "exchange": "NASDAQ", "averageChange": 1.5}]
        mock_client._make_request.return_value = mock_response
    ...
    @pytest.mark.asyncio
    async def test_historical_sector_performance_basic(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.historical_sector_performance("Energy")
    ...
    @pytest.mark.asyncio
    async def test_historical_sector_performance_with_dates(self, market_performance_category, mock_client):
        """Test historical sector performance with date parameters"""
        mock_response = [{"date": "2024-02-01", "sector": "Energy", "exchange": "NASDAQ", "averageChange": 0.6398}]
        mock_client._make_request.return_value = mock_response
        ...
        mock_client._make_request.assert_called_once_with(
            "historical-sector-performance",
            {"sector": "Energy", "from": "2024-02-01", "to": "2024-03-01", "exchange": "NASDAQ"}
        )
    
    @pytest.mark.asyncio
    async def test_historical_industry_performance_basic(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.historical_industry_performance("Biotechnology")
    ...
    @pytest.mark.asyncio
    async def test_historical_industry_performance_with_dates(self, market_performance_category, mock_client):
        """Test historical industry performance with date parameters"""
        mock_response = [{"date": "2024-02-01", "industry": "Biotechnology", "exchange": "NASDAQ", "averageChange": 1.1479}]
        mock_client._make_request.return_value = mock_response
        ...
        mock_client._make_request.assert_called_once_with(
            "historical-industry-performance",
            {"industry": "Biotechnology", "from": "2024-02-01", "to": "2024-03-01", "exchange": "NASDAQ"}
        )
    
    @pytest.mark.asyncio
    async def test_sector_pe_snapshot_basic(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_sector_pe_snapshot_with_optional_params(self, market_performance_category, mock_client):
        """Test sector P/E snapshot with all parameters"""
        mock_response = [{"date": "2024-02-01", "sector": "Energy", "exchange": "NASDAQ", "pe": 14.5}]
        mock_client._make_request.return_value = mock_response
    ...
    @pytest.mark.asyncio
    async def test_industry_pe_snapshot_basic(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_industry_pe_snapshot_with_optional_params(self, market_performance_category, mock_client):
        """Test industry P/E snapshot with all parameters"""
        mock_response = [{"date": "2024-02-01", "industry": "Biotechnology", "exchange": "NASDAQ", "pe": 10.2}]
        mock_client._make_request.return_value = mock_response
    ...
    @pytest.mark.asyncio
    async def test_historical_sector_pe_basic(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_historical_sector_pe_with_dates(self, market_performance_category, mock_client):
        """Test historical sector P/E with date parameters"""
        mock_response = [{"date": "2024-02-01", "sector": "Energy", "exchange": "NASDAQ", "pe": 14.4114}]
        mock_client._make_request.return_value = mock_response
    ...
    @pytest.mark.asyncio
    async def test_historical_industry_pe_basic(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.historical_industry_pe("Biotechnology")
    ...
    @pytest.mark.asyncio
    async def test_historical_industry_pe_with_dates(self, market_performance_category, mock_client):
        """Test historical industry P/E with date parameters"""
        mock_response = [{"date": "2024-02-01", "industry": "Biotechnology", "exchange": "NASDAQ", "pe": 10.1816}]
        mock_client._make_request.return_value = mock_response
    ...
    @pytest.mark.asyncio
    async def test_biggest_gainers_basic(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_most_active_stocks_basic(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_empty_response_handling(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_large_response_handling(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_response_structure_validation(self, market_performance_category, mock_client):
    ...
    async def test_different_sectors(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.historical_sector_performance("Technology")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-sector-performance",
            {"sector": "Technology"}
        ...
        result = await market_performance_category.historical_sector_performance("Healthcare")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-sector-performance",
            {"sector": "Healthcare"}
    ...
    async def test_different_industries(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.historical_industry_performance("Software")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-industry-performance",
            {"industry": "Software"}
        ...
        result = await market_performance_category.historical_industry_performance("Banking")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-industry-performance",
            {"industry": "Banking"}
    ...
    async def test_different_exchanges(self, market_performance_category, mock_client):
        ...
        # Test with NASDAQ
        result = await market_performance_category.sector_performance_snapshot(snapshot_date, exchange="NASDAQ")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-02-01", "exchange": "NASDAQ"}
        )
        
        # Test with NYSE
        result = await market_performance_category.sector_performance_snapshot(snapshot_date, exchange="NYSE")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-02-01", "exchange": "NYSE"}
        )
        
        # Test with AMEX
        result = await market_performance_category.sector_performance_snapshot(snapshot_date, exchange="AMEX")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-02-01", "exchange": "AMEX"}
        )
    ...
    async def test_date_edge_cases(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.sector_performance_snapshot(leap_date)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-02-29"}
        ...
        result = await market_performance_category.sector_performance_snapshot(year_boundary)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-12-31"}
        ...
        result = await market_performance_category.sector_performance_snapshot(year_beginning)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-01-01"}
    ...
    @pytest.mark.asyncio
    async def test_sector_performance_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_industry_performance_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_sector_pe_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_industry_pe_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_biggest_gainers_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_biggest_losers_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_most_active_stocks_response_validation(self, market_performance_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_parameter_combinations(self, market_performance_category, mock_client):
        ...
        result = await market_performance_category.sector_performance_snapshot(snapshot_date, sector="Energy")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "sector-performance-snapshot",
            {"date": "2024-02-01", "sector": "Energy"}
        )
    ...
    @pytest.mark.asyncio
    async def test_historical_date_combinations(self, market_performance_category, mock_client):
        ...
        from_date = date(2024, 2, 1)
        result = await market_performance_category.historical_sector_performance("Energy", from_date=from_date)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-sector-performance",
            {"sector": "Energy", "from": "2024-02-01"}
        )
        
        # Test with sector and to_date
        to_date = date(2024, 3, 1)
        result = await market_performance_category.historical_sector_performance("Energy", to_date=to_date)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-sector-performance",
            {"sector": "Energy", "to": "2024-03-01"}
        )
        
        # Test with sector and exchange
        result = await market_performance_category.historical_sector_performance("Energy", exchange="NASDAQ")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "historical-sector-performance",
