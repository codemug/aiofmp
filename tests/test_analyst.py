...
class TestAnalystCategory:
    ...
    @pytest.mark.asyncio
    async def test_financial_estimates_with_optional_params(self, analyst_category, mock_client):
        """Test financial estimates with all parameters"""
        mock_response = [{"symbol": "AAPL", "revenueAvg": 483093000000}]
        mock_client._make_request.return_value = mock_response
        
        result = await analyst_category.financial_estimates("AAPL", "quarter", page=2, limit=20)
    ...
    @pytest.mark.asyncio
    async def test_price_target_news_with_optional_params(self, analyst_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_price_target_latest_news_with_params(self, analyst_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_historical_stock_grades_with_limit(self, analyst_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_stock_grade_news_with_optional_params(self, analyst_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_stock_grade_latest_news_with_params(self, analyst_category, mock_client):
