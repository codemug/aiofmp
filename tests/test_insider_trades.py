...
class TestInsiderTradesCategory:
    ...
    @pytest.mark.asyncio
    async def test_latest_insider_trades_basic(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_latest_insider_trades_with_optional_params(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_latest_insider_trades_with_date(self, insider_trades_category, mock_client):
        """Test latest insider trades with date parameter"""
        mock_response = [{"symbol": "APA", "filingDate": "2025-02-04"}]
        mock_client._make_request.return_value = mock_response
        
        trade_date = date(2025, 2, 4)
        result = await insider_trades_category.latest_insider_trades(trade_date=trade_date)
    ...
    @pytest.mark.asyncio
    async def test_search_insider_trades_basic(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_search_insider_trades_with_symbol(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_search_insider_trades_with_all_params(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_search_by_reporting_name_basic(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_all_transaction_types_basic(self, insider_trades_category, mock_client):
        ...
        assert result == mock_response
        mock_client._make_request.assert_called_once_with("insider-trading-transaction-type")
    
    @pytest.mark.asyncio
    async def test_insider_trade_statistics_basic(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_acquisition_ownership_basic(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_acquisition_ownership_with_limit(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_response_structure_validation(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_different_transaction_types(self, insider_trades_category, mock_client):
        """Test insider trades functionality with different transaction types"""
        mock_response = [{"symbol": "AAPL", "transactionType": "S-Sale"}]
        mock_client._make_request.return_value = mock_response
        
        # Test with Sale
        result = await insider_trades_category.search_insider_trades(transaction_type="S-Sale")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/search",
            {"transactionType": "S-Sale"}
        ...
        # Test with Purchase
        result = await insider_trades_category.search_insider_trades(transaction_type="P-Purchase")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/search",
            {"transactionType": "P-Purchase"}
        ...
        # Test with Award
        result = await insider_trades_category.search_insider_trades(transaction_type="A-Award")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/search",
            {"transactionType": "A-Award"}
    ...
    async def test_different_names(self, insider_trades_category, mock_client):
        ...
        mock_response = [{"reportingCik": "0001548760", "reportingName": "Zuckerberg Mark"}]
        mock_client._make_request.return_value = mock_response
    ...
    async def test_date_edge_cases(self, insider_trades_category, mock_client):
        ...
        result = await insider_trades_category.latest_insider_trades(trade_date=leap_date)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/latest",
            {"date": "2024-02-29"}
        ...
        result = await insider_trades_category.latest_insider_trades(trade_date=year_boundary)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/latest",
            {"date": "2025-12-31"}
        ...
        result = await insider_trades_category.latest_insider_trades(trade_date=year_beginning)
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/latest",
            {"date": "2025-01-01"}
    ...
    @pytest.mark.asyncio
    async def test_latest_insider_trades_response_validation(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_search_insider_trades_response_validation(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_search_by_reporting_name_response_validation(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_all_transaction_types_response_validation(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_insider_trade_statistics_response_validation(self, insider_trades_category, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_acquisition_ownership_response_validation(self, insider_trades_category, mock_client):
    ...
    async def test_parameter_combinations(self, insider_trades_category, mock_client):
        ...
        result = await insider_trades_category.search_insider_trades(reporting_cik="0001214128")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/search",
            {"reportingCik": "0001214128"}
        ...
        result = await insider_trades_category.search_insider_trades(company_cik="0000320193")
        assert result == mock_response
        mock_client._make_request.assert_called_with(
            "insider-trading/search",
            {"companyCik": "0000320193"}
